...
<artifactId>vertx-service-discovery-scala_2.12</artifactId>
...
----
compile 'io.vertx:vertx-service-discovery-scala_2.12:3.4.2-SNAPSHOT'
----
...
be populated with `link:../../scaladocs/io/vertx/scala/servicediscovery/spi/ServiceImporter.html[ServiceImporter]`s.
